    ...
    <div>
        ...
        <div class="d-flex align-items-center gap-2">
            <?php if ($doc['especialidad']): ?>
                <span class="badge"><?= htmlspecialchars($doc['especialidad']) ?></span>
            <?php endif; ?>
            ...
            <?php else: ?>
                <span class="badge badge-general"><i class="bi bi-globe"></i> Documento general</span>
            <?php endif; ?>
