    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-group">
                ...
                <input type="text" id="documento_identidad" name="documento_identidad" class="form-input w-100" maxlength="8" pattern="\d{8}" placeholder="8 dígitos">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-group">
                ...
                <input type="text" id="licencia" name="licencia" class="form-input w-100" maxlength="50" placeholder="N° de licencia">
            </div>
        </div>
        <div class="col-md-6 mb-3">
            <div class="form-group">
                <label for="telefono" class="form-label">Teléfono</label>
                <input type="text" id="telefono" name="telefono" class="form-input w-100" maxlength="9" placeholder="099123456">
            </div>
        </div>
    </div>
